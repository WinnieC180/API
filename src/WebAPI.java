...
public class WebAPI {
    public static void getNowPlaying() {
        ...
        String APIkey = "//APIKEY"; // your personal API key on TheMovieDatabase
        ...
        String url2 = "https://api.themoviedb.org/3/movie/" + ID + queryParameters;
        String urlResponse2 = "";
        ...
        JSONObject movie = new JSONObject(urlResponse2);
